...
//  }
  ...
  if(g_chargerControllerDelayBetweenStages != 0) g_chargerControllerDelayBetweenStages--;
  if(g_chargerFailSafeTaskDelayVariable != 0) g_chargerFailSafeTaskDelayVariable--;
