...
//  PR1=15875;//T1 period reg
  ...
  // PORT INIT ---------------------------------------
   ...
   // Diods for testing
  TRISEbits.TRISE4= OUTPUT;//LED
//  LATEbits.LATE4=1;

  TRISEbits.TRISE5= OUTPUT;//LED
//  LATEbits.LATE5=1;

  TRISEbits.TRISE6= OUTPUT;//LED
//  LATEbits.LATE6=1;
  ...
  TRISDbits.TRISD7 = OUTPUT; // CHARGER_EN_PIN
  TRISDbits.TRISD5 = OUTPUT; // SEL_MEASURE_100_10_PIN
  TRISDbits.TRISD4 = OUTPUT; // FANOX_EN_PIN
  TRISDbits.TRISD3 = OUTPUT; // RES_EN_PIN
  
  TRISEbits.TRISE3 = OUTPUT; // DISCH_EN_PIN
  TRISEbits.TRISE2 = OUTPUT; // SWITCH_100A_PIN
